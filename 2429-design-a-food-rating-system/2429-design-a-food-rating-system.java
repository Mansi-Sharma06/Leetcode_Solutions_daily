...
class FoodRatings {
    ...
    private Map<String, Integer> foodRatingMap; // food -> rating

    private Map<String, String> foodCuisineMap; // food -> cuisine

    private Map<String, PriorityQueue<Food>> cuisineFoodMap; // cuisine -> food array pq
